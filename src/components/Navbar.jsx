                    ...
                    >
                        ...
                        {isAuthenticated ? (
                            <div className="space-y-4">
                                ...
                                <button onClick={handleLogout} className="block w-full text-center bg-red-500/20 text-red-400 py-4 rounded-2xl font-black border border-red-500/20">{t('Logou')}</button>
                            </div>
                        ) : (
