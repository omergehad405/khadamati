...
const RegisterPage = () => {
    ...
    return (
        <div className="max-w-2xl mx-auto mt-16 bg-white rounded-3xl shadow-xl border border-slate-100 p-8 md:p-12 animate-fadeIn">
            <div className="text-center mb-10">
                ...
                {/* Role Toggle */}
                <div className="flex max-w-xs mx-auto bg-slate-100 p-1 rounded-2xl">
                    <button
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {role === 'worker' && (
                    <div className="flex flex-col items-center justify-center mb-8 p-6 border-2 border-dashed border-slate-200 rounded-2xl bg-slate-50 relative min-h-[160px]">
                        {imagePreview ? (
                            <div className="relative">
                                <img src={imagePreview} alt="Preview" className="w-32 h-32 rounded-full object-cover border-4 border-white shadow-md" />
                                <button
                                    type="button"
